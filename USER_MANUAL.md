...
| Center | Tab request, curl input, options, pre-request script |
...
Nhấn **Compare** trên topbar để mở cửa sổ so sánh curl.

### 11.1 Mục đích

Compare giúp thấy khác biệt giữa nhiều curl:
...
- Paste curl vào từng panel
- Nhấn **So sánh**
- Dòng khác biệt được highlight
- Có thể thêm/xoá panel
- Có thể load từ các tab đang mở

Compare là semantic diff, không chỉ so raw text, nên thứ tự flag khác nhau vẫn dễ đọc.
